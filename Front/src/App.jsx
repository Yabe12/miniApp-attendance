...
import logo from "../src/assets/d.jpg"; // Import logo
import QrScanner from "react-qr-scanner"; // Import QR scanner

const App = () => {
  // State for form data and UI visibility
        ...
        {showAttendance && (
          <div className="flex flex-col items-center">
            ...
            <button
              type="button"
              onClick={handleBackClick}
              className="mt-4 bg-blue-500 text-white rounded px-6 py-2 transition duration-200 ease-in-out hover:bg-blue-700 shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-300"
            >
              Back
            </button>
          </div>
